...
class EntranceExamTestCases(ModuleStoreTestCase):
    ...
    def setUp(self):
        ...
        milestones_api.add_course_milestone(unicode(self.course.id), 'requires', self.milestone)
        ...
        modulestore().update_item(self.course, user.id)
