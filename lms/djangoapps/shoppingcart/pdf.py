...
class PDFInvoice(object):
    ...
    def __init__(self, context):
        ...
        self.brand_logo_height = microsite.get_value("PDF_RECEIPT_LOGO_HEIGHT_MM", settings.PDF_RECEIPT_LOGO_HEIGHT_MM) * mm
        self.cobrand_logo_height = microsite.get_value("PDF_RECEIPT_COBRAND_LOGO_HEIGHT_MM", settings.PDF_RECEIPT_COBRAND_LOGO_HEIGHT_MM) * mm
    ...
    def draw_logos(self):
        ...
        if logo_img:
            ...
            self.pdf.drawImage(logo_img.filename,
                               ...
                               img_width, self.brand_logo_height, mask='auto')
